...
export function serializeDefaultNodes(
  ...
  switch (node.type) {
    ...
    case 'paragraph': {
      return (
        <p className={`col-start-2 ${indentClass} ${textAlignClass}`} key={index}>
          {serializedChildren}
        </p>
      )
    }
    case 'heading': {
      ...
      return (
        <Tag className={`col-start-2 ${indentClass} ${textAlignClass}`} key={index}>
          {serializedChildren}
        </Tag>
      )
    }
    case 'list': {
      const Tag = node?.tag
      return (
        <Tag className={`list col-start-2 ${indentClass} ${textAlignClass}`} key={index}>
          {serializedChildren}
        </Tag>
      )
    }
    ...
    case 'quote': {
      return (
        <blockquote className={`col-start-2 ${indentClass} ${textAlignClass}`} key={index}>
          {serializedChildren}
        </blockquote>
      )
    }
