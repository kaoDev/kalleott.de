...
export type NodeTypes =
  ...
  | SerializedInlineBlockNode<
      Extract<Page['layout'][0], { blockType: 'mediaBlock' }> | CodeBlockProps | HtmlBlockProps
    >
        ...
        if (node.type === 'block') {
          ...
          switch (blockType) {
            ...
            case 'mediaBlock':
              return (
                <MediaBlock
                  className="col-start-1 col-span-3 mx-auto"
                  imgClassName="m-0"
                  key={index}
                  {...block}
            ...
            case 'html':
              return <HtmlBlock className="col-start-2" key={index} {...block} />
            default:
              return null
          }
