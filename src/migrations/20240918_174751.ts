...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  DO $$ BEGIN
   CREATE TYPE "public"."enum_pages_blocks_hot_sauces_populate_by" AS ENUM('collection', 'selection');
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   CREATE TYPE "public"."enum_pages_blocks_hot_sauces_relation_to" AS ENUM('hot-sauces');
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   CREATE TYPE "public"."enum__pages_v_blocks_hot_sauces_populate_by" AS ENUM('collection', 'selection');
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   CREATE TYPE "public"."enum__pages_v_blocks_hot_sauces_relation_to" AS ENUM('hot-sauces');
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_hot_sauces" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populateBy" "enum_pages_blocks_hot_sauces_populate_by" DEFAULT 'collection',
  	"relationTo" "enum_pages_blocks_hot_sauces_relation_to" DEFAULT 'hot-sauces',
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_hot_sauces" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populateBy" "enum__pages_v_blocks_hot_sauces_populate_by" DEFAULT 'collection',
  	"relationTo" "enum__pages_v_blocks_hot_sauces_relation_to" DEFAULT 'hot-sauces',
  	"limit" numeric DEFAULT 20,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "media" (
  	...
  	"sizes_xxxl_url" varchar,
  	"sizes_xxxl_width" numeric,
  	"sizes_xxxl_height" numeric,
  	"sizes_xxxl_mime_type" varchar,
  	"sizes_xxxl_filesize" numeric,
  	"sizes_xxxl_filename" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "hot_sauces_gallery" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "hot_sauces" (
  	...
  	"heat_level" numeric,
  	"slug" varchar,
  	"cooked_at" timestamp(3) with time zone,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  
  CREATE TABLE IF NOT EXISTS "hot_sauces_texts" (
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "competencies_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "hot_sauce_order_form_blocks_form_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "hot_sauce_order_form" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_hot_sauces" ADD CONSTRAINT "pages_blocks_hot_sauces_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_rels" ADD CONSTRAINT "pages_rels_hot_sauces_fk" FOREIGN KEY ("hot_sauces_id") REFERENCES "public"."hot_sauces"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_hot_sauces" ADD CONSTRAINT "_pages_v_blocks_hot_sauces_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_rels" ADD CONSTRAINT "_pages_v_rels_hot_sauces_fk" FOREIGN KEY ("hot_sauces_id") REFERENCES "public"."hot_sauces"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "posts" ADD CONSTRAINT "posts_hero_id_media_id_fk" FOREIGN KEY ("hero_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_posts_v" ADD CONSTRAINT "_posts_v_version_hero_id_media_id_fk" FOREIGN KEY ("version_hero_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "hot_sauces_gallery" ADD CONSTRAINT "hot_sauces_gallery_gallery_image_id_media_id_fk" FOREIGN KEY ("gallery_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "hot_sauces_gallery" ADD CONSTRAINT "hot_sauces_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."hot_sauces"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "hot_sauces" ADD CONSTRAINT "hot_sauces_hero_image_id_media_id_fk" FOREIGN KEY ("hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "hot_sauces_texts" ADD CONSTRAINT "hot_sauces_texts_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."hot_sauces"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "competencies_rels" ADD CONSTRAINT "competencies_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."competencies"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "competencies_rels" ADD CONSTRAINT "competencies_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "projects_rels" ADD CONSTRAINT "projects_rels_competencies_fk" FOREIGN KEY ("competencies_id") REFERENCES "public"."competencies"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "hot_sauce_order_form_blocks_form_block" ADD CONSTRAINT "hot_sauce_order_form_blocks_form_block_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "hot_sauce_order_form_blocks_form_block" ADD CONSTRAINT "hot_sauce_order_form_blocks_form_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."hot_sauce_order_form"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_hot_sauces_order_idx" ON "pages_blocks_hot_sauces" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_hot_sauces_parent_id_idx" ON "pages_blocks_hot_sauces" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_hot_sauces_path_idx" ON "pages_blocks_hot_sauces" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_hot_sauces_order_idx" ON "_pages_v_blocks_hot_sauces" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_hot_sauces_parent_id_idx" ON "_pages_v_blocks_hot_sauces" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_hot_sauces_path_idx" ON "_pages_v_blocks_hot_sauces" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "media_sizes_xxl_sizes_xxl_filename_idx" ON "media" USING btree ("sizes_xxl_filename");
  CREATE INDEX IF NOT EXISTS "media_sizes_xxxl_sizes_xxxl_filename_idx" ON "media" USING btree ("sizes_xxxl_filename");
  ...
  CREATE INDEX IF NOT EXISTS "hot_sauces_gallery_order_idx" ON "hot_sauces_gallery" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "hot_sauces_gallery_parent_id_idx" ON "hot_sauces_gallery" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "hot_sauces_slug_idx" ON "hot_sauces" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "hot_sauces_created_at_idx" ON "hot_sauces" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "hot_sauces_texts_order_parent_idx" ON "hot_sauces_texts" USING btree ("order","parent_id");
  CREATE INDEX IF NOT EXISTS "competencies_created_at_idx" ON "competencies" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "competencies_rels_order_idx" ON "competencies_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "competencies_rels_parent_idx" ON "competencies_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "competencies_rels_path_idx" ON "competencies_rels" USING btree ("path");
  ...
  CREATE INDEX IF NOT EXISTS "hot_sauce_order_form_blocks_form_block_order_idx" ON "hot_sauce_order_form_blocks_form_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "hot_sauce_order_form_blocks_form_block_parent_id_idx" ON "hot_sauce_order_form_blocks_form_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "hot_sauce_order_form_blocks_form_block_path_idx" ON "hot_sauce_order_form_blocks_form_block" USING btree ("_path");`);
}
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_hot_sauces";
  DROP TABLE "pages";
  ...
  DROP TABLE "_pages_v_blocks_hot_sauces";
  DROP TABLE "_pages_v";
  ...
  DROP TABLE "users";
  DROP TABLE "hot_sauces_gallery";
  DROP TABLE "hot_sauces";
  DROP TABLE "hot_sauces_texts";
  DROP TABLE "competencies";
  DROP TABLE "competencies_rels";
  DROP TABLE "projects";
  ...
  DROP TABLE "hot_sauce_order_form_blocks_form_block";
  DROP TABLE "hot_sauce_order_form";`);
}
