---
title: IoT — Setup and first steps with the Raspberry Pi Zero
createdAt: "2018-11-05T20:55:47.678Z"
course: Internet of Things
draft: false
coverImage: /images/iot/raspberry-pi-zero.webp
excerpt:
  "Set up and start using the Raspberry Pi Zero, including preparing the
  operating system, enabling WiFi and SSH, and finding the device on your
  network. Learn to install Node.js and create a simple project to make an LED
  blink using JavaScript."
---
