...
createdAt: "2018-12-17T18:38:15.272Z"
course: Internet of Things
tags: digital to analogue, MCP3008, soil moisture
draft: false
coverImage: /images/iot/automated-greenhouse-part-1.webp
excerpt:
  "Start building an automated greenhouse using a Raspberry Pi, sensors, and an
  analog-digital converter. This guide covers setting up the hardware, enabling
  SPI, connecting a soil moisture sensor, and writing a Node.js program to read
  and send sensor data to the cloud."
---
...
![soil moisture sensor](/images/iot/soil-moisture-sensor.jpg)
...
![menu of raspi-config](/images/iot/raspi-config.png)
...
![pin layout f the MCP3008](/images/iot/mcp3008.png)
...
![schematics of the connected MCP3008](/images/iot/schematic-sensors-dht11-soil.png)
