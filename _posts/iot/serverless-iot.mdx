...
createdAt: "2018-12-03T16:14:03.190Z"
course: Internet of Things
tags: firebase, serverless, saas
draft: false
coverImage: /images/iot/serverless-iot.webp
excerpt:
  "Explore the benefits of serverless architecture for IoT projects, focusing on
  using Firebase for real-time data management and deployment. This guide covers
  setting up Firebase, authenticating with Google, and migrating from
  traditional storage solutions to a serverless approach for efficient, scalable
  applications."
---
...
![firebase projects overview](/images/iot/firebase-projects.png)
...
![firebase projects overview](/images/iot/firebase-create-project.png)
...
![view of the firestore database content](/images/iot/firebase-database.png)
